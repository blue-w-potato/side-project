...
def main( Category, table ):
    ...
    with open( file = "main\\WBs.txt", mode = "r", encoding = "utf-8" ) as file:
...
def click_to_open(table):
    ...
    with open( file = "main\\title\\Category.txt", mode = "r", encoding = "utf-8" ) as txt:
        Category = txt.read()
    main( Category, table )
...
def click_to_close(table):
    ...
    with open( file = "main\\title\\Category.txt", mode = "r", encoding = "utf-8" ) as txt:
        Category = txt.read()
    with open( file = "main\\title\\Canva_type.txt", mode = "r", encoding = "utf-8" ) as txt:
        Canva_type = txt.read()
