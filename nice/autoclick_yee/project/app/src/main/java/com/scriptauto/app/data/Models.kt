...
/** 拖曳圖示時用「像素位移」更新相對座標,並夾在 0..1 之間 */
fun RelativePosition.shiftBy(dxPx: Float, dyPx: Float, canvasWidthPx: Float, canvasHeightPx: Float): RelativePosition {
    val newX = (xPercent + dxPx / canvasWidthPx).coerceIn(0f, 1f)
    val newY = (yPercent + dyPx / canvasHeightPx).coerceIn(0f, 1f)
